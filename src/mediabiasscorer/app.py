...
from mediabiasscorer.log import get_log_reversed, make_logger
from mediabiasscorer.settings import API_KEY, IS_TEST
from mediabiasscorer.util import async_download
...
APP_DISPLAY_NAME = "mediabiasscorer"
...
def main() -> None:
    ...
    uvicorn.run(
        "mediabiasscorer.app:app", host="localhost", port=port, reload=True
    )
